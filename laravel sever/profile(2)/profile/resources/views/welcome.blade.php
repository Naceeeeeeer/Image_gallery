  ...
  font-family: "Poppins", -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";
    ...
    <body class="antialiased">
        <div data-bs-theme="dark" style="background-image: url('{{  asset('images/header.png') }}');
            ...
            background-position: center; /* Adjust as needed */  color: white;
          ...
          " class="relative sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            @if (Route::has('login'))
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    @auth
                        <a href="{{ url('/images') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Go to Album</a>
                    @else
            ...
            <div  class=" flex justify-center items-center w-full xl:w-4/5 p-12 overflow-hidden mx-40">
           <!-- <img class="mx-auto w-full md:w-4/5 transform -rotate-6 transition hover:scale-105 duration-700 ease-in-out hover:rotate-6" src="{{  asset('images/gallery.jpg') }}" /> -->
          <style>
...
@keyframes slid {
  ...
  <span style="--i:8;"><img src="https://i.postimg.cc/0QckxSpt/Opera-Snapshot-2020-07-03-161422-www-freepik-com.png" alt="not found"></span>
        ...
        <h1 class="display-4">Bienvenue dans Votre Galerie d'Images</h1>
        <p class="lead">Découvrez et partagez des images incroyables avec notre application de galerie.</p>
        <br>
...
<!-- <section class="py-5 text-center container">
    <div class="row py-lg-5">
        <div class="col-lg-6 col-md-8 mx-auto">
            <h1 class="fw-light">Welcome to your album</h1>
