...
<!-- <div class="navbar navbar-dark bg-dark shadow-sm">
 ...
 <div data-bs-theme="dark" class="album py-5 bg-body-tertiary grid-gallery" style="background-image: url('{{  asset('images/header.png') }}');
        ...
        <div class="image-list">
            <form action="{{ route('voiture.upload.post') }}" method="POST" enctype="multipart/form-data">
                @csrf
        ...
        <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center">
                <div  class="btn-group" style="">
                    <form action="{{ route('voiture.delete', $image->id) }}" method="POST" class="delete-form">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-sm btn-outline-secondary delete-btn">Delete</button>
                    </form>
                    <form action="{{ route('voiture.edit', $image->id) }}" class="edit-form">
